...
for subject=1:nsubjects
    ...
    sample_map = tEEG_ts_class_backend_noise_v1(subject+1, noise_pos, eeg_type, ntrials, parietal); %1class-score x 494timepoints
...
xlabel('time (ms)');
title('Train lg Vs. sm Center - Test noise'); %Individual Superposition Classification Accuracy');
...
fig_title = strcat(conds.EEG_type{eeg_type},'_',noise_types{noise_pos},'_nTrials:',ntrials);
MarkPlot(fig_title);
